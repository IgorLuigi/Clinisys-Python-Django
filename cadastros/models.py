...
class Paciente(models.Model):
    ...
    cpf = models.IntegerField(
        verbose_name="Qual o seu CPF?", help_text="Informe o seu CPF")
    rg = models.IntegerField(
        verbose_name="Qual o seu RG?", help_text="Informe o seu RG")
    endereco = models.CharField(verbose_name="Qual o seu endereço completo?",
                                help_text="Informe o seu endereço completo, contendo RUA, NÚMERO e BAIRRO")
...
class Funcionario(models.Model):
    ...
    endereco = models.CharField(verbose_name="Qual o seu endereço completo?",
                                help_text="Informe o seu endereço completo, contendo RUA, NÚMERO e BAIRRO")
    funcao = models.CharField(max_length=50, verbose_name="Qual a sua função?",
                              help_text="Informe qual o seu cargo dentro da clínica")
...
class Agenda(models.Model):
    ...
    descricaoAtendimento = models.CharField(
...
class Consulta(models.Model):
    ...
    procedimentoRealizado = models.CharField(
        verbose_name="Descrição dos procedimentos realizados")
